...
if (addFooter) {
    ...
    <li class="social-item"> <a class="youtube" href="https://www.youtube.com/@GrCode-Club" target="_blank"><span></span> <span></span> <span></span> <span></span><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
  </ul>`;
